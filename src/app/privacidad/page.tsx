...
export const metadata = {
  title: 'Política de Privacidad – MatchProp',
  description: 'Política de privacidad y tratamiento de datos personales de MatchProp.',
}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-12">
            ...
            <div className="prose prose-gray max-w-none space-y-8 text-sm text-gray-700 leading-relaxed">
              ...
              <section>
                ...
                <p>
                  MatchProp (en adelante, "la plataforma") es responsable del tratamiento de los datos personales
              ...
              <section>
                ...
                <p className="mt-2">
                  MatchProp <strong>no vende, cede ni alquila</strong> datos personales a terceros, salvo en los
                  siguientes casos:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <section>
                ...
                <p className="mt-2">
                  No obstante, ningún sistema de transmisión por Internet es 100% seguro. MatchProp no puede
              ...
              <section>
                ...
                <p>
                  MatchProp utiliza cookies de sesión necesarias para el funcionamiento de la plataforma
