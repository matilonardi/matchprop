...
- **HEADFUL=1 (obligatorio desde jul 2026):** la build nueva de WhatsApp Web desloguea al instante ("Desconectado: LOGOUT" post-QR) las sesiones vinculadas desde Chrome headless. El bot debe correr con ventana visible (minimizada está OK); el plist ya lo setea. Síntoma si se rompe de nuevo: LOGOUT inmediato tras escanear el QR con sesión limpia.
